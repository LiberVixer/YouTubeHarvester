...
Target machine used for the 1.1.1 Windows build:
...
```text
YouTubeHarvester-1.1.1-offline\
  deno\
    deno.exe
  ffmpeg\
    bin\
...
```text
dist\release\YouTubeHarvester_1.1.1_windows_portable.zip
dist\release\YouTubeHarvester_1.1.1_windows_setup.exe
dist\release\YouTubeHarvester_1.1.1_windows_x64.msi
