...
Target machine used for the 1.1.2 Windows build:
...
```text
YouTubeHarvester-1.1.2-offline\
  deno\
    deno.exe
  ffmpeg\
    bin\
...
```text
dist\release\YouTubeHarvester_1.1.2_windows_portable.zip
dist\release\YouTubeHarvester_1.1.2_windows_setup.exe
dist\release\YouTubeHarvester_1.1.2_windows_x64.msi
