...
Бягучыя зыходнікі версіі для ПК падтрымліваюць каналы Rutube па адрасах
`https://rutube.ru/channel/ID/` і `https://rutube.ru/u/імя/`, уключаючы раздзелы
Відэа і Shorts. Імянныя адрасы ператвараюцца ў ID для абароны ад дубляў;
захоўваюцца назва і аватар, працуюць ліміты, расклад, архіў і пазначэнне апошніх
відэа як архіваваных. Праверка трансляцый і платнага кантэнту Rutube пакуль выключана.
Асобныя ролікі працуюць у чарзе і хуткім спампоўванні. Android-порт не зменены.
