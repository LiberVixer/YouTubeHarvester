...
TAG="${YTH_RELEASE_TAG:-v0.2.5-beta}"
TITLE="${YTH_RELEASE_TITLE:-YouTube Harvester 0.2.5 Beta}"
...
BODY_FILE="${YTH_RELEASE_BODY:-$ROOT_DIR/docs/releases/0.2.5-beta.md}"
TOKEN_FILE="${GITHUB_TOKEN_FILE:-$HOME/.config/youtube-harvester/github-token}"
PRERELEASE="${YTH_RELEASE_PRERELEASE:-false}"

ASSETS=(
    "$WINDOWS_DIR/YouTubeHarvester_0.2.5-beta_windows_portable.zip"
    "$WINDOWS_DIR/YouTubeHarvester_0.2.5-beta_windows_setup.exe"
    "$WINDOWS_DIR/YouTubeHarvester_0.2.5-beta_windows_x64.msi"
    "$WINDOWS_DIR/SHA256SUMS-windows.txt"
    "$LINUX_DIR/YouTubeHarvester_0.2.5-beta_linux_all.deb"
    "$LINUX_DIR/YouTubeHarvester_0.2.5-beta_source.tar.gz"
