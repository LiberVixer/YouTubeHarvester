...
ASSETS=(
    ...
    "$WINDOWS_DIR/YouTubeHarvester_${RELEASE_VERSION}_windows_setup.exe"
    "$WINDOWS_DIR/YouTubeHarvester_${RELEASE_VERSION}_windows_x64.msi"
    "$WINDOWS_DIR/SHA256SUMS-windows.txt"
    "$LINUX_DIR/YouTubeHarvester_${RELEASE_VERSION}_linux_all.deb"
    "$LINUX_DIR/YouTubeHarvester_${RELEASE_VERSION}_source.tar.gz"
