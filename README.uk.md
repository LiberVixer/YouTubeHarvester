...
Поточні вихідні коди версії для ПК підтримують канали Rutube за адресами
`https://rutube.ru/channel/ID/` та `https://rutube.ru/u/ім’я/`, включно з розділами
Відео й Shorts. Іменні адреси перетворюються на ID для захисту від дублів;
зберігаються назва й аватар, працюють ліміти, розклад, архів і позначення останніх
відео як архівованих. Перевірка трансляцій і платного контенту Rutube поки вимкнена.
Окремі ролики працюють у черзі та швидкому завантаженні. Android-порт не змінено.
